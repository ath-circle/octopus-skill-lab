...
class Settings(BaseSettings):
    ...
    skillalchemy_skill_path: str = Field(default=".tools/skillalchemy", alias="SKILLALCHEMY_SKILL_PATH")
    skillcreator_agent_bin: str = Field(default="codex", alias="SKILLCREATOR_AGENT_BIN")
    skillcreator_skill_path: str = Field(default=".tools/anthropic-skills/skills/skill-creator", alias="SKILLCREATOR_SKILL_PATH")
