...
export default function Dashboard() {
  ...
  async function operate(action: "evaluate" | "promote" | "rollback", releaseId?: string) {
    ...
    const request = action === "evaluate"
      ? { url: `/versions/${selectedVersion.id}/evaluate-holdouts`, body: { engine: "codex", baseline_version_id: active?.skill_version_id } }
